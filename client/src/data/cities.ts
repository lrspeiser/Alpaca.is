  ...
  cities: {
    ...
    amsterdam: {
      ...
      items: [
        ...
        { id: 'amsterdam-12', text: 'Arrive in Amsterdam', completed: true, isCenterSpace: true, description: 'Welcome to Amsterdam! This beautiful Dutch capital is famous for its elaborate canal system, narrow houses, artistic heritage, and cycling culture.' },
    ...
    barcelona: {
      ...
      items: [
        ...
        { id: 'barcelona-12', text: 'Arrive in Barcelona', completed: true, isCenterSpace: true, description: 'Welcome to Barcelona! Known for its stunning architecture, beautiful beaches, and vibrant culture, Barcelona is the cosmopolitan capital of Spain\'s Catalonia region.' },
    ...
    london: {
      ...
      items: [
        ...
        { id: 'london-12', text: 'Arrive in London', completed: true, isCenterSpace: true, description: 'Welcome to London! The capital of England and the United Kingdom is a 21st-century city with history stretching back to Roman times, famous for its iconic landmarks, museums, and diverse cultural scene.' },
    ...
    paris: {
      ...
      items: [
        ...
        { id: 'paris-12', text: 'Arrive in Paris', completed: true, isCenterSpace: true, description: 'Welcome to Paris! The capital of France, known as the "City of Light," is famous for its art, fashion, gastronomy, and culture. The city\'s iconic landmarks include the Eiffel Tower, Notre-Dame Cathedral, and the Louvre Museum.' },
    ...
    rome: {
      ...
      items: [
        ...
        { id: 'rome-12', text: 'Arrive in Rome', completed: true, isCenterSpace: true, description: 'Welcome to Rome! The "Eternal City" and capital of Italy has a history spanning over 2,500 years. It\'s famous for ancient ruins like the Colosseum, Renaissance masterpieces, and delicious cuisine.' },
    ...
    vienna: {
      ...
      items: [
        ...
        { id: 'vienna-12', text: 'Arrive in Vienna', completed: true, isCenterSpace: true, description: 'Welcome to Vienna! The capital of Austria is known for its imperial palaces, classical music heritage, and café culture. This elegant city was once home to Mozart, Beethoven, and Sigmund Freud.' },
